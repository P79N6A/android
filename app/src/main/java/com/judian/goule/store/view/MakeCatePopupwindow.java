...
public class MakeCatePopupwindow extends PopupWindow {
    ...
    public MakeCatePopupwindow(final Context context, int  height, final OnOptionLister lister) {
        super(context);
        mContext=context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.popup_cate_make, null);
...
//                }
//                CateBean.ResultBean  bean=   list.get(position);
//                 if (bean.isSel()){
//                      bean.setSel(false);
