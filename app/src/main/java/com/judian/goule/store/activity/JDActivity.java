...
public class JDActivity extends BaseActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitle.setText(title);
         switch (op){
             ...
             case 2:
                 cateTab.setVisibility(View.VISIBLE);
    ...
    private void initList() {
        ...
        homeData = AdapterUtil.getJDData(this,new ArrayList<GoodListBean.ResultBean>());
    ...
    private void initWebGo() {
        ...
        webView.loadUrl("https://wqs.jd.com/order/orderlist_merge.shtml");
...
//                Logger.e("bbbb44", "WebResourceResponse == ");
    ...
    private void initCate() {
        ...
        presenter.getJDCate(new BaseView<CateBean>() {
            @Override
            public void result(CateBean bean) {
                if (bean.getCode() == 200) {
                    tabTile = bean.getResult();
                    initTab(bean.getResult());
                    mWindow = new CatePopupwindow(JDActivity.this,tabAll.getHeight(), bean.getResult(), new CatePopupwindow.OnOptionLister() {
                        @Override
    ...
    @OnClick({R.id.back, R.id.zh, R.id.sl, R.id.juane, R.id.move, R.id.jiag, R.id.jies, R.id.title})
    ...
    BaseView<GoodListBean> goodView = new BaseView<GoodListBean>() {
        ...
        public void result(GoodListBean bean) {
            ...
            if (bean.getCode() == 200) {
                ...
                ToastUtils.toast(JDActivity.this,bean.getMsg());
                homeData.loadMoreEnd();
            }
        }
