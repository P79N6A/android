package com.judian.goule.store.zxing.encode;
...
public final class EncodingHandler {
     ...
     * @throws Exception
     */
    public static Bitmap createBarCode(String str, Integer width) throws Exception {
            BitMatrix bitMatrix = new MultiFormatWriter().encode(str, BarcodeFormat.CODE_128, width, width, getEncodeHintMap());
