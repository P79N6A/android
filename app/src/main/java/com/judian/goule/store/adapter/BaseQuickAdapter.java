 ...
 */
public abstract class BaseQuickAdapter<T> extends DelegateAdapter.Adapter<BaseViewHolder> {
    ...
    public void addAll(List<T>  t){
        mData.addAll(t);
//        Log.i("BaseQuickAdapter","addAll 1");
        notifyDataSetChanged();
//        Log.i("BaseQuickAdapter","addAll 2");
    }
...
//        Log.i("BaseQuickAdapter","addAll 2");
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        try {
            if (viewType == viewType) {
                return new BaseViewHolder(LayoutInflater.from(mContext).inflate(mLayoutResId, parent, false));
            }
            return null;
        }catch (Exception e){
    ...
    protected BaseViewHolder createBaseViewHolder(View view) {
        ...
        // 泛型擦除会导致z为null
        if (z == null) {
            Log.i("xxxxxxxxx","createBaseViewHolder == null"+z);
            k = (BaseViewHolder) new BaseViewHolder(view);
        } else {
            Log.i("xxxxxxxxx","createBaseViewHolder == z"+z);
            k = createGenericKInstance(z, view);
            Log.i("xxxxxxxxx","createBaseViewHolder == k  "+(k != null));
        }
