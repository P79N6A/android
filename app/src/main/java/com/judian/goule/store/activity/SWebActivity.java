...
public class SWebActivity extends BaseActivity {

    private static String POSITION = "SWebActivity";
    ...
    public static void openSurl(Context context, String bean) {
        Intent intent = new Intent(context, SWebActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        keyword = getIntent().getStringExtra(POSITION);
        initWebSet();
...
//                Logger.e("aaaaaaaaaaa","  url =="+view.getUrl());
                ...
                if (newProgress == 100) {
                     if (title!=null)title.setText( view.getTitle());
        ...
        presenter.getSUrl(keyword, new BaseView<BaseBean>() {
            @Override
            public void result(BaseBean bean) {
                if (bean.getCode() == 200)
                    AliManage.getInstance(SWebActivity.this).showUrl(bean.getResult().getUrl(), webAli, chromeClient, callBack);
                else ToastUtils.toast(SWebActivity.this, bean.getMsg());
            }
...
//            int mainBizOrderIds = paramString.indexOf("mainBizOrderIds") + 20;
            ...
            new CdataPresenter(SWebActivity.this).getBindOrderAll(orders);
        }
    }
