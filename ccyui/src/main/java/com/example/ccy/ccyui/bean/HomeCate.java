...
public class HomeCate implements Serializable {
    ...
    public HomeCate(int icon, String cate_name,int id) {
        this.id=id;
        this.icon = icon;
        this.cate_name = cate_name;
    }
    public HomeCate(int icon, String cate_name,String id) {
        this.intro=id;
        this.icon = icon;
        this.cate_name = cate_name;
    }

    public HomeCate(int icon, String cate_name,String intro, int id ) {
        this.intro = intro;
        this.id = id;
        this.cate_name = cate_name;
        this.icon = icon;
    ...
    public HomeCate(String intro, String cate_name, int id, int icon) {
        this.intro = intro;
        this.cate_name = cate_name;
        this.id = id;
        this.icon = icon;
    ...
    public HomeCate( String cate_name,String intro) {
        this.intro = intro;
        this.cate_name = cate_name;
    }
