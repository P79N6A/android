...
class LineGraphicView extends View
{
    ...
    {
        mPaint.setColor(res.getColor(R.color.crop__button_bar));
        ...
        mPaint.setColor(res.getColor(R.color.crop__button_text));
    ...
    private void drawText(String text, int x, int y, Canvas canvas)
    {
        ...
        p.setColor(res.getColor(R.color.crop__button_bar));
