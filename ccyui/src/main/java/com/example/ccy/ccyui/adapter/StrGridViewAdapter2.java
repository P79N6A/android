...
//网格视图适配器
public class StrGridViewAdapter2 extends BaseAdapter {

	private Context mContext;
	private List<HomeCate> mList;//


	public StrGridViewAdapter2(Context context, List<HomeCate> list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			convertView = layoutInflater.inflate(R.layout.sub_str_grid, null);
