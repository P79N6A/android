...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder(final View view) {
        super(view);
        Log.i("xxxxxxxxx","BaseViewHolder  新建 ");
        if ( views==null){
    ...
    public BaseViewHolder setText(@IdRes int viewId, CharSequence value) {
        ...
        public BaseViewHolder setTextView(@IdRes int viewId, CharSequence value) {
        TextView view = getView(viewId);
        view.setText(value);
        return this;
    }
    ...
    public BaseViewHolder setTextPaint(@IdRes int viewId, CharSequence value) {
        TextView view = getView(viewId);
        view.setText(value);
        view.getPaint().setFlags(Paint.STRIKE_THRU_TEXT_FLAG);
        view.getPaint().setAntiAlias(true);
        return this;
    }    public BaseViewHolder setTextPaint(@IdRes int viewId, CharSequence value,Typeface typeface) {
        TextView view = getView(viewId);
        view.setText(value);
        view.getPaint().setFlags(Paint.STRIKE_THRU_TEXT_FLAG);
        view.getPaint().setAntiAlias(true);
    ...
    public BaseViewHolder setText(@IdRes int viewId, CharSequence value,Typeface typeface) {
        TextView view = getView(viewId);
        view.setText(value);
        view.setTypeface(typeface);
        return this;
    ...
    public <T extends View> T getView(@IdRes int viewId) {
        ...
        if (view == null) {
            Log.i("xxxxxxxxx","BaseViewHolder viewId== "+viewId);
            view = itemView.findViewById(viewId);
            views.put(viewId, view);
            Log.i("xxxxxxxxx","BaseViewHolder views.size() =="+views.size());
        }
        return (T) view;
    }
